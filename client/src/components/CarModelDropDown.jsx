...
<Listbox value={selected} onChange={setSelected}>
      <Label className="block text-sm/6 font-medium dark:text-slate-200 text-gray-900">Car Type</Label>
          ...
          {model.map((model) => (
            ...
            >
              <div className="flex items-center">
                <span className=" block truncate font-normal group-data-selected:font-semibold">{model.name}</span>
              </div>
