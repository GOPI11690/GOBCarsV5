    ...
    <div className='flex flex-wrap pt-15 lg:justify-center'>
        ...
        <div className="grid container pt-10 grid-cols-1 gap-y-16 lg:grid-cols-1 lg:items-center lg:gap-x-12">
            ...
            <div className="grid grid-cols-1 gap-12 sm:gap-10  sm:grid-cols-2">
                    <div className="flex flex-col rounded-lg hover:bg-gray-200 hover:border-gray-200 text-left">
                    
                      <div className="relative flex ">
                        <div className='w-32 px-5' >
                        <img className='h-20 dark:invert' src="https://img.icons8.com/ios/100/car-rental.png" alt="car-rental"/>
                  ...
                  <dd className="text-6xl text-left font-extrabold mb-4 text-gray-500 md:text-6xl">
                    ...
                    <div className="flex flex-col rounded-lg hover:bg-gray-200 hover:border-gray-200 text-left">
                      ...
                      <div className="relative flex h-30">
                        <div className='w-32 px-5' >
                        <img className='h-20 dark:invert' src="https://img.icons8.com/wired/64/bill.png" alt="processing"/>
                  ...
                  <dd className="text-6xl text-left font-extrabold mb-4 text-gray-500 md:text-6xl">
                    ...
                    <div className="flex flex-col rounded-lg hover:bg-gray-200 hover:border-gray-200 text-left">
                      ...
                      <div className="relative flex h-30">
                        <div className='w-32 px-5' >
                        <img className='h-20 dark:invert' src="https://img.icons8.com/ios/100/car-cleaning.png" alt="car-cleaning"/>
                  ...
                  <dd className="text-6xl text-left font-extrabold mb-4 text-gray-500 md:text-6xl">
                    ...
                    <div className="relative flex h-30">
                      <div className='w-32 px-5' >
                      <img className='h-20 dark:invert' src="https://img.icons8.com/windows/100/home.png" alt="home"/>
                ...
                <dd className="text-6xl text-left font-extrabold mb-4 text-gray-500 md:text-6xl">
                  ...
                  <div className="flex flex-col rounded-lg hover:bg-gray-200 hover:border-gray-200 text-left">
                    ...
                    <div className="relative flex h-30">
                      <div className='w-32 px-5' >
                      <img className='h-20 dark:invert' src="https://img.icons8.com/windows/500/thumb-up.png" alt="thumb-up"/>
                ...
                <dd className="text-6xl text-left font-extrabold mb-4 text-gray-500 md:text-6xl">
                  ...
                  <div className="flex flex-col rounded-lg hover:bg-gray-200 hover:border-gray-200 text-left">
                    ...
                    <div className="relative flex h-30 ">
                      <div className='w-32 px-5' >
                      <img className='h-20 dark:invert' src="https://img.icons8.com/ios/100/present.png" alt="present"/>
